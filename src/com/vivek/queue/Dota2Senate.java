...
public class Dota2Senate {
    ...
    public static void main(String[] args) {
        Dota2Senate helper = new Dota2Senate();
        System.out.println(helper.predictPartyVictory("DDRRR")); // D
        System.out.println(helper.predictPartyVictory("RD"));    // R
        System.out.println(helper.predictPartyVictory("RDD"));   // D
        System.out.println(helper.predictPartyVictory("RR"));    // R
        System.out.println(helper.predictPartyVictory("R"));     // R
        System.out.println(helper.predictPartyVictory("DDD"));   // D
    }
    ...
    public String predictPartyVictory(String senate) {
        ...
        return !dQueue.isEmpty() ? "Dire" : "Radiant";
    }
