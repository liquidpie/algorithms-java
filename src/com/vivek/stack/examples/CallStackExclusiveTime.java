 ...
 */
public class CallStackExclusiveTime {
    ...
    public static int[] exclusiveTime(int n, List<String> logs) {
        ...
        for (String log : logs) {
            ...
            if (split[1].equals("start")) {
                if (!jobs.isEmpty()) {
                    res[jobs.peek()] += currentTimestamp - prevTimestamp;
                }
                jobs.push(jobId);
                prevTimestamp = currentTimestamp;
            } else {
                res[jobs.pop()] += currentTimestamp - prevTimestamp + 1;
    ...
    public static void main(String[] args) {
        System.out.println(Arrays.toString(exclusiveTime(2, List.of("0:start:0", "1:start:2", "1:end:5", "0:end:7"))));
    }
