...
public class FindPivotIndex {
    ...
    public static void main(String[] args) {
        FindPivotIndex helper = new FindPivotIndex();
        {
            int[] nums = {1,7,3,6,5,6};
            System.out.println(helper.pivotIndex(nums)); // 3
        }
        {
            int[] nums = {1,2,3};
            System.out.println(helper.pivotIndex(nums)); // -1
        }
        {
            int[] nums = {2,1,-1};
            System.out.println(helper.pivotIndex(nums)); // 0
        }
    }
